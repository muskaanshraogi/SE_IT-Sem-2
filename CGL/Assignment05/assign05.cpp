...
Batch : H10
Problem Statement :
        Implement Cohen Sutherland algorithm to clip an given line/polygon. Provide the vertices of the line/polygon to be clipped and the pattern of clipping interactively.
Date : 
---------------------------------------------------------------------------------------------*/
